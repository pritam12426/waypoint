...
/// `trashed_at`; the FTS trash trigger removes its search entry. Any older
/// trashed copy of the same URL is purged first (see `trash_with_dedup`),
/// so the trash stays free of duplicate URLs.
